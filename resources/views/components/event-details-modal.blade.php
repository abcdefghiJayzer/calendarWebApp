    ...
    function openEventModal(event) {
        ...
        content.innerHTML = `
            <div class="space-y-4">
                ...
                <div class="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-100 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-100">
                            <div class="flex items-center space-x-3 mb-2">
                                ...
                                <h4 class="text-sm font-semibold text-blue-900">Start Time</h4>
                            </div>
                            <p class="text-lg font-medium text-gray-800 ml-11">${formatDate(startDate)}</p>
                        </div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-100">
                            <div class="flex items-center space-x-3 mb-2">
                                ...
                                <h4 class="text-sm font-semibold text-red-900">End Time</h4>
                            </div>
                            <p class="text-lg font-medium text-gray-800 ml-11">${endDate ? formatDate(endDate) : 'No end time specified'}</p>
                        </div>
                    </div>

                    <div class="mt-6 bg-white p-4 rounded-lg shadow-sm border border-blue-100">
                        <div class="flex items-center space-x-3 mb-2">
                            ...
                            <h4 class="text-sm font-semibold text-green-900">Duration</h4>
                        </div>
                        <p class="text-lg font-medium text-gray-800 ml-11">${getDuration(startDate, endDate)}</p>
                    </div>
                </div>
